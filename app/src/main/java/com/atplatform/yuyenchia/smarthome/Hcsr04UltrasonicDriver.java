...
public class Hcsr04UltrasonicDriver implements AutoCloseable {
    ...
    private com.atplatform.yuyenchia.smarthome.Hcsr04 device;

    public Hcsr04UltrasonicDriver(String trigPin, String echoPin) throws IOException {
        device = new com.atplatform.yuyenchia.smarthome.Hcsr04(trigPin, echoPin);
    }

    private static UserSensor build(final com.atplatform.yuyenchia.smarthome.Hcsr04 hcsr04) {
